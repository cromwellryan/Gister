...
namespace Gister_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new GisterPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(EchelonTouchInc.Gister.GuidList.guidGisterCmdSet, (int)EchelonTouchInc.Gister.PkgCmdIDList.cmdCreateGist);
